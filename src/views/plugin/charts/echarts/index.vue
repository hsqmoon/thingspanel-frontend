...
const { setDomRef: setPieRef } = useEcharts(() => pieOptions.value)
...
const { setDomRef: setLineRef } = useEcharts(() => lineOptions.value)
...
const { setDomRef: setBarRef } = useEcharts(() => barOptions.value)

const pictorialBarOption = ref<ECOption>(getPictorialBarOption()) as Ref<ECOption>
const { setDomRef: setPictorialBarRef } = useEcharts(() => pictorialBarOption.value)
...
const { setDomRef: setScatterRef } = useEcharts(() => scatterOptions.value)
...
const { setDomRef: setRadarRef } = useEcharts(() => radarOptions.value)
...
const { setDomRef: setGaugeRef } = useEcharts(() => gaugeOptions.value, {
  onDestroy: chart => {
...
<template>
  <NSpace :vertical="true" :size="16">
    <NCard :bordered="false" class="rounded-8px shadow-sm">
      <div :ref="setPieRef" class="h-400px"></div>
    </NCard>
    <NCard :bordered="false" class="rounded-8px shadow-sm">
      <div :ref="setLineRef" class="h-400px"></div>
    </NCard>
    <NCard :bordered="false" class="rounded-8px shadow-sm">
      <div :ref="setBarRef" class="h-400px"></div>
    </NCard>
    <NCard :bordered="false" class="rounded-8px shadow-sm">
      <div :ref="setPictorialBarRef" class="h-600px"></div>
    </NCard>
    <NCard :bordered="false" class="rounded-8px shadow-sm">
      <div :ref="setScatterRef" class="h-600px"></div>
    </NCard>
    <NCard :bordered="false" class="rounded-8px shadow-sm">
      <div :ref="setRadarRef" class="h-400px"></div>
    </NCard>
    <NCard :bordered="false" class="rounded-8px shadow-sm">
      <div :ref="setGaugeRef" class="h-640px"></div>
    </NCard>
  </NSpace>
</template>
